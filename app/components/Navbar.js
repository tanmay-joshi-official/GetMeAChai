      ...
      <div>
        <ul className='flex gap-4'>
          <div className="flex gap-4">
            ...
            {session && <div className="dropdown relative" onClick={() => setdropdown(!dropdown)} onBlur={() => setTimeout(() => setdropdown(false), 100)}>
              <button className="cursor-pointer px-4 p-2 rounded-full bg-linear-to-r from-purple-800 to-teal-800 hover:scale-105 transition-all hover:bg-linear-to-r hover:from-purple-950 hover:to-teal-900 active:bg-linear-to-r active:from-purple-950 active:to-teal-950 flex items-center gap-2">Profile <IoMdArrowDropdown />
                <ul className={`options absolute top-12 mx-auto w-46 bg-slate-800 rounded-md shadow-lg dropdown-menu items-start ${dropdown ? 'block' : 'hidden'}`}>
                  ...
                  <li className="rounded-lg m-2 my-0 px-4 py-2 hover:bg-slate-700 active:bg-slate-800 transition-all cursor-pointer">Settings</li>
                  <li className="rounded-lg m-2 my-0 px-4 py-2 hover:bg-slate-700 active:bg-slate-800 transition-all cursor-pointer" onClick={() => signOut()}>Sign Out</li>
                </ul></button>
            </div>}
